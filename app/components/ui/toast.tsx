...
import { type ComponentPropsWithoutRef, type ComponentRef, type ReactElement } from 'react';

const ToastProvider = ToastPrimitives.Provider;

const ToastViewport = ({ className, ...props }: ComponentPropsWithoutRef<typeof ToastPrimitives.Viewport>) => (
...
const ToastAction = ({ className, ...props }: ComponentPropsWithoutRef<typeof ToastPrimitives.Action>) => (
...
const ToastClose = ({ className, ...props }: ComponentPropsWithoutRef<typeof ToastPrimitives.Close>) => (
...
const ToastTitle = ({ className, ...props }: ComponentPropsWithoutRef<typeof ToastPrimitives.Title>) => (
  <ToastPrimitives.Title className={cn('text-sm font-semibold', className)} {...props} />
);
ToastTitle.displayName = ToastPrimitives.Title.displayName;

const ToastDescription = ({ className, ...props }: ComponentPropsWithoutRef<typeof ToastPrimitives.Description>) => (
